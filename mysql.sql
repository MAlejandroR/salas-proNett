...
(119, 'Par�s15', 'MÁLAGA', 'MÁLAGA', 'C. la Orotava, 25-27, PI San Lu�s, 29006', '952038626', 'info@paris15.es', 'http://www.paris15.es/', 'Rock, Metal, Pop', '3000\r'),
(120, 'ZZ PUB', 'MÁLAGA', 'MÁLAGA', 'C. Tej�n y Rodr�guez, 6, 29008', '678643450', 'info@zzpub.es', 'http://www.zzpub.es/', 'Rock, Pop, Blues', '100\r'),
...
(123, 'Sala X', 'SEVILLA', 'Sevilla', 'C/ José D�az, 7, 41009', '667422219', 'programacion@rocknrollaproducciones.com', 'http://lasalax.com/', 'Rock, Pop', '380\r'),
